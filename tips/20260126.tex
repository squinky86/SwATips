...
\paragraph{The false claim} has been made that broadly applies this rescission to all of Software Assurance when the focus is on dependency lists, Bills of Material, and other supply chain security requirements.
